...
bam_list <- list.files(
    path = "../../sc/scRiboSeq_manuscript/data_processing/work_addCB",
...
matrix_dir <- "data/sc/quantification/"
...
sra <- read.csv("../../sc/SraRunTable_PRJNA680481.csv") #path relative to DOTSeq_paper_2026
...
## uORF-only UMAP (sparse-aware; keep cells with uORF UMIs > 50)
